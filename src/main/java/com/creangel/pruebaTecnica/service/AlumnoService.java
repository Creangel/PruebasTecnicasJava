...
public class AlumnoService {
    ...
    public Optional<Alumno> obtenerAlumnoPorId(String id) {
        return alumnoRepository.findById(Integer.parseInt(id));
    }
    ...
    public Alumno actualizarAlumno(String id, Alumno alumnoActualizado) {
        Optional<Alumno> alumnoExistente = alumnoRepository.findById(Integer.parseInt(id));
    ...
    public void eliminarAlumno(String id) {
        if (!alumnoRepository.existsById(Integer.parseInt(id))) {
            throw new RuntimeException("No se encontró el alumno con ID: " + id);
        }
